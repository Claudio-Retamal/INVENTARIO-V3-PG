...
use App\Filament\Resources\Personals\Pages\ViewPersonal;
use App\Filament\Resources\Personals\Schemas\PersonalForm;
use App\Filament\Resources\Personals\Schemas\PersonalInfolist;
...
protected static ?int $navigationSort = 3;
    ...
    {
        return PersonalInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewPersonal::route('/{record}'),
